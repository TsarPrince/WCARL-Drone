    ...
    return (
        <Layout>
            <div className="container-xxl">
                ...
                {isOnline ? <Loader label={"Connected to the network"} passes={true} speed={"Download Speed: " +checkSpeed+" Mbps"}/> : <Loader label={"Not connected to the network"} passes={false}/> }
